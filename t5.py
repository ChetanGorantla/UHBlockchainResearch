...
def test_t5_model(node_url, prompt, retries=3, timeout=10):
    attempt = 0
...
# Test the T5-small model on both nodes
node0_metrics = test_t5_model(node0_url, prompt)
node1_metrics = test_t5_model(node1_url, prompt)

# Print the metrics for both nodes
print("Node 0 Metrics (T5-small):", node0_metrics)
print("Node 1 Metrics (T5-small):", node1_metrics)
